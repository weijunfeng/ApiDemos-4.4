...
public class IntentActivityFlags extends Activity {
    ...
    private Intent[] buildIntentsToViewsLists() {
        ...
        intent.setClass(IntentActivityFlags.this, com.example.android.apis4.ApiDemos.class);
        intent.putExtra("com.example.android.apis4.Path", "Views");
        intents[1] = intent;

        intent = new Intent(Intent.ACTION_MAIN);
        intent.setClass(IntentActivityFlags.this, com.example.android.apis4.ApiDemos.class);
        intent.putExtra("com.example.android.apis4.Path", "Views/Lists");
