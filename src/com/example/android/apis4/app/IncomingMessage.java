...
package com.example.android.apis4.app;
...
public class IncomingMessage extends Activity {
    ...
    static Intent[] makeMessageIntentStack(Context context, CharSequence from,
        ...
        intents[0] = Intent.makeRestartActivityTask(new ComponentName(context,
                com.example.android.apis4.ApiDemos.class));

        // "App"
        intents[1] = new Intent(context, com.example.android.apis4.ApiDemos.class);
        intents[1].putExtra("com.example.android.apis4.Path", "App");
        // "App/Notification"
        intents[2] = new Intent(context, com.example.android.apis4.ApiDemos.class);
        intents[2].putExtra("com.example.android.apis4.Path", "App/Notification");
