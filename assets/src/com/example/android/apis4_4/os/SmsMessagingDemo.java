...
public class SmsMessagingDemo extends BaseActi {
    /** Tag string for our debug logs */
    private static final String TAG = "SmsMessagingDemo";

    public static final String SMS_RECIPIENT_EXTRA = "com.example.android.apis4_4.os.SMS_RECIPIENT";

    public static final String ACTION_SMS_SENT = "com.example.android.apis4_4.os.SMS_SENT_ACTION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ComponentName componentName = new ComponentName("com.example.android.apis4_4",
                "com.example.android.apis4_4.os.SmsMessageReceiver");
