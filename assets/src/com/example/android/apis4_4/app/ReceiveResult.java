...
<table class="LinkTable">
        <tr>
            <td class="LinkColumn">src/com.example.android.apis4_4/app/ReceiveResult.java</td>
            <td class="DescrColumn">Launches pick activity and receives its result</td>
        </tr>
        <tr>
            <td class="LinkColumn">src/com.example.android.apis4_4/app/SendResult.java</td>
 ...
 */
public class ReceiveResult extends BaseActi {
    /**
