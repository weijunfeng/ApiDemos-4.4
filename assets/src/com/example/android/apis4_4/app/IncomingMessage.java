 ...
 */
public class IncomingMessage extends BaseActi {
    @Override
    ...
    static Intent[] makeMessageIntentStack(Context context, CharSequence from,
        ...
        // "App"
        intents[1] = new Intent(context, com.example.android.apis4_4.ApiDemos.class);
        intents[1].putExtra("com.example.android.apis4_4.Path", "App");
        // "App/Notification"
        intents[2] = new Intent(context, com.example.android.apis4_4.ApiDemos.class);
