 ...
 */
public class StatusBarNotifications extends BaseActi {
    ...
    private PendingIntent makeDefaultIntent() {
        ...
        intents[0] = Intent.makeRestartActivityTask(new ComponentName(this,
                com.example.android.apis4_4.ApiDemos.class));

        // "App"
        intents[1] = new Intent(this, com.example.android.apis4_4.ApiDemos.class);
        intents[1].putExtra("com.example.android.apis4_4.Path", "App");
        // "App/Notification"
        intents[2] = new Intent(this, com.example.android.apis4_4.ApiDemos.class);
        intents[2].putExtra("com.example.android.apis4_4.Path", "App/Notification");
